...
module.exports = {
  async up(queryInterface) {
    ...
    CREATE TABLE IF NOT EXISTS USER_ROLES (
      ...
      CONSTRAINT FK_USER_ROLE_USER_ROLE_ID FOREIGN KEY (USER_ROLE_ID) REFERENCES USER_ROLE (ID),
    ...
    CREATE TABLE IF NOT EXISTS CASE_CASE (
      ...
      CONSTRAINT FK_CASE_CASE_ASSIGNED_USER_ID FOREIGN KEY (ASSIGNED_USER_ID) REFERENCES USER (ID),
      PRIMARY KEY (ID)
    );
    ...
    CREATE TABLE IF NOT EXISTS COMMENT_V2 (
      ...
      CONSTRAINT FK_COMMENT_V2_USER_CREATOR_ID FOREIGN KEY (USER_CREATOR_ID) REFERENCES USER (ID),
      ...
      CONSTRAINT FK_COMMENT_V2_USER_RECEIVER_ID FOREIGN KEY (USER_RECEIVER_ID) REFERENCES USER (ID)
    );
    ...
    CREATE TABLE IF NOT EXISTS CASE_HISTORY (
      ...
      CONSTRAINT FK_CASE_HISTORY_USER_ID FOREIGN KEY (USER_ID) REFERENCES USER (ID),
