...
module.exports = {
  async up(queryInterface) {
    ...
    CREATE TABLE IF NOT EXISTS APPLICATION_FEE_CODES (
      ...
      DESCRIPTION VARCHAR NOT NULL,
      FEE_TYPE VARCHAR(10) NOT NULL DEFAULT 'FIXED',
    ...
    CREATE TABLE IF NOT EXISTS CASE_HISTORY (
      ...
      CONSTRAINT FK_CASE_HISTORY_ADMIN_USER_ID FOREIGN KEY (ADMIN_USER_ID) REFERENCES ADMIN_USER (ID),
  ...
  async down(queryInterface) {
    ...
    DROP TABLE IF EXISTS CASE_TRANSACTION_FEE;
