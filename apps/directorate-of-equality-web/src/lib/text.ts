...
export const overviewText = {
  ...
  companyQuarantined: 'Fyrirtæki er í sóttkví',
...
export const companiesText = {
  ...
  detailView: {
    ...
    quarantineButton: 'Setja í sóttkví',
    quarantineStopButton: 'Taka úr sóttkví',
    quarantinedToast: 'Fyrirtæki sett í sóttkví',
    unquarantinedToast: 'Fyrirtæki tekið úr sóttkví',
    quarantineErrorToast: 'Villa við að uppfæra sóttkví',
