...
module.exports = {
  async up(queryInterface) {
    ...
    CREATE TYPE BANKRUPTCY_APPLICATION_STATUS AS ENUM (
      'DRAFT',
      'SUBMITTED'
    );
    ...
    CREATE TABLE BANKRUPTCY_APPLICATION (
      ...
      STATUS BANKRUPTCY_APPLICATION_STATUS NOT NULL DEFAULT 'DRAFT',

      ADDITIONAL_TEXT TEXT DEFAULT NULL,
      JUDGMENT_DATE TIMESTAMPTZ DEFAULT NULL,
      CLAIMS_SENT_TO TEXT DEFAULT NULL,
      ...
      LOCATION_NATIONAL_ID TEXT DEFAULT NULL,
      LOCATION_ADDRESS TEXT DEFAULT NULL,
      LOCATION_DEADLINE_DATE TIMESTAMPTZ DEFAULT NULL,

      PUBLISHING_DATES TIMESTAMP WITH TIME ZONE[] DEFAULT NULL,
