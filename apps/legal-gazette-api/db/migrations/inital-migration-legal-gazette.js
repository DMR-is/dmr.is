...
module.exports = {
  async up(queryInterface) {
    ...
    CREATE TABLE SETTLEMENT (
      ...
      SETTLEMENT_DEADLINE_DATE TIMESTAMPTZ NOT NULL,
    ...
    CREATE TABLE BANKRUPTCY_DIVISION_ADVERT (
      ID UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
      CREATED_AT TIMESTAMPTZ DEFAULT CURRENT_TIMESTAMP,
      UPDATED_AT TIMESTAMPTZ DEFAULT CURRENT_TIMESTAMP,
      DELETED_AT TIMESTAMPTZ,
    ...
    -- TODO: Add bankruptcy settlement closure advert table (skiptalok)
    ...
    CREATE TABLE BANKRUPTCY_APPLICATION (
      ID UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
      CREATED_AT TIMESTAMPTZ DEFAULT CURRENT_TIMESTAMP,
      UPDATED_AT TIMESTAMPTZ DEFAULT CURRENT_TIMESTAMP,
      DELETED_AT TIMESTAMPTZ,
    ...
    CREATE TABLE DECEASED_APPLICATION (
      ID UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
      CREATED_AT TIMESTAMPTZ DEFAULT CURRENT_TIMESTAMP,
      UPDATED_AT TIMESTAMPTZ DEFAULT CURRENT_TIMESTAMP,
      DELETED_AT TIMESTAMPTZ,
      ...
      COURT_DISTRICT_ID UUID REFERENCES COURT_DISTRICT(ID) DEFAULT NULL,
      CASE_ID UUID NOT NULL REFERENCES CASES(ID)
    );
