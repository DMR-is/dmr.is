...
module.exports = {
  async up(queryInterface) {
    ...
    CREATE TABLE TYPE_CATEGORIES (
      ...
      TYPE_ID UUID NOT NULL REFERENCES ADVERT_TYPE(ID),
      CATEGORY_ID UUID NOT NULL REFERENCES ADVERT_CATEGORY(ID),
    ...
    CREATE TABLE SETTLEMENT (
      ...
      DECLARED_CLAIMS TEXT DEFAULT NULL
    );
    ...
    CREATE TABLE ADVERT (
      ...
      LEGACY_ID UUID DEFAULT NULL, -- ID from the old system, used for data migration purposes
      ASSIGNED_USER_ID UUID DEFAULT NULL REFERENCES LEGAL_GAZETTE_USERS(ID),
      CASE_ID UUID DEFAULT NULL REFERENCES CASES(ID),
    ...
    CREATE TABLE APPLICATION (
      ...
      TYPE_ID UUID DEFAULT NULL REFERENCES ADVERT_TYPE(ID),
  ...
  async down(queryInterface) {
    ...
    DROP TABLE IF EXISTS ADVERT_PUBLICATION;
