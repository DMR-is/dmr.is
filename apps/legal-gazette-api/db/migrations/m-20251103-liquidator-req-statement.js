...
module.exports = {
  up: (queryInterface, Sequelize) => {
    return queryInterface.sequelize.query(`
      ...
      ALTER TABLE SETTLEMENT
        ADD COLUMN LIQUIDATOR_RECALL_STATEMENT_LOCATION TEXT DEFAULT NULL,
        ADD COLUMN LIQUIDATOR_RECALL_STATEMENT_TYPE TEXT NOT NULL DEFAULT 'LIQUIDATOR_LOCATION';
  ...
  down(queryInterface, Sequelize) {
    return queryInterface.sequelize.query(`
      ...
      ALTER TABLE SETTLEMENT
        DROP COLUMN IF EXISTS LIQUIDATOR_RECALL_STATEMENT_LOCATION,
        DROP COLUMN IF EXISTS LIQUIDATOR_RECALL_STATEMENT_TYPE DEFAULT 'LIQUIDATOR_LOCATION';
