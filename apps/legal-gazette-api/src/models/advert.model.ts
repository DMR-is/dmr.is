...
class CommonAdvertAndApplicationFieldsDto {
  @ApiProperty({ type: String })
  @IsUUID()
  typeId!: string
...
export class CreateAdvertAndCommonApplicationBodyDto {
  @ApiProperty({ type: String })
  @IsString()
  ...
  @ApiProperty({ type: CommonAdvertAndApplicationFieldsDto })
  @ValidateNested()
  @Type(() => CommonAdvertAndApplicationFieldsDto)
  fields!: CommonAdvertAndApplicationFieldsDto
...
export class CreateAdvertAndRecallBankruptcyApplicationBodyDto {
  @ApiProperty({ type: String })
  @IsString()
  applicantNationalId!: string
}

export class CreateAdvertAndRecallDeceasedApplicationBodyDto {
  @ApiProperty({ type: String })
  @IsString()
  applicantNationalId!: string
}
