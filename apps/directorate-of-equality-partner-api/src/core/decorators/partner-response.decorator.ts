 ...
 * Jafnréttisstofa's register. The submissions carry one more conflict of their
 * own — a previous report still in review — which the routes had never
 * declared.
 */
