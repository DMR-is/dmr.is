...
import { messages } from '../../lib/messages/advertMigration'
import { loginRedirect } from '../../lib/utils'
import { authOptions } from '../api/auth/[...nextauth]'

const AdvertMigrationTabs = dynamic(
  () => import('../../components/tabs/AdvertMigrationTabs'),
  {
    ssr: false,
    loading: () => (
      <SkeletonLoader
...
export default function AdvertMigrationPage() {
