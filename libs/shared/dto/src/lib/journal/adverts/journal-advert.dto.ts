...
import { JournalAdvertInvolvedParty } from '../involved-parties/journal-involvedparty.dto'
...
export class JournalAdvert {
  ...
  readonly involvedParty!: JournalAdvertInvolvedParty | null
  ...
  readonly signature!: JournalSignatureBody | null
}
